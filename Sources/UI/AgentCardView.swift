...
struct AgentCardView: View {
    ...
    private func openTerminal() {
        ...
        // Try to find and activate the existing terminal window running this session.
        // Strategy: find the claude PID, get its parent TTY, match to Terminal.app window.
        // Fallback: activate Terminal.app and let the user find it.
